...
//TODO
export function ParseStepRightSolutionsPrelimScoreSheet(htmlString: string, searchDivision: Division) : Competition | undefined {
    ...
    var leaderPrelimComp = new PrelimCompetition(date, searchDivision, Round.Prelims, Role.Leader);
    var followerPrelimComp = new PrelimCompetition(date, searchDivision, Round.Prelims, Role.Follower);
...
//TODO
export function ParseStepRightSolutionsFinalScoreSheet(htmlString: string, searchDivision: Division) : Competition | undefined {
    var comp = new Competition();

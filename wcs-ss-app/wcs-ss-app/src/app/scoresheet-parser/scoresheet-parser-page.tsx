...
import PrelimAdder from "@/components/full-prelim-adder";

export default function ScoresheetParserPage() {  
  ...
  //where prelim competition info will be submitted after it's been edited
  function HandlePrelimCompetition(competition: PrelimCompetition) {
    ...
    if (leaderCompetition != undefined && followerCompetition != undefined && round != Round.Finals) {      
      return (
        <div>
          ...
          <PrelimAdder handlePrelimCompetition={HandlePrelimCompetition} competition={leaderCompetition}/>
        </div>
      )
    }
    else {
